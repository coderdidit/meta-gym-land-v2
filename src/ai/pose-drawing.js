...
export const drawPose = (canvasRef, results) => {
  ...
  if (results.poseLandmarks) {
    ...
    drawLandmarks(
      canvasCtx,
      Object.values(le).map((index) => results.poseLandmarks[index]),
      {
        color: mainEyeColor,
        fillColor: mainEyeColor,
    ...
    drawLandmarks(
      canvasCtx,
      Object.values(re).map((index) => results.poseLandmarks[index]),
      {
        color: mainEyeColor,
        fillColor: mainEyeColor,
        lineWidth: mainEyeLineWidth,
    ...
    if (CurPose === gpose.HTR) {
      drawLine(
        nose,
        { x: canvasRef?.current.width, y: nose.y },
        ACTIVE_COLOR,
        canvasCtx,
        width,
        height,
